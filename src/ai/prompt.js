...
SCORING RUBRIC:
- 1:    Single word AND phrase (e.g., "fix", "wip", "test code").
- 2-3:  Generic title that does not follow the conventional commit title type (e.g test the write command) and with no bulleted body OR details.
...
2. For any commit scored below 6:
   ...
   - If the commit title is very good, DO NOT bother suggesting a better commit title but talk about other ways the commit should improve
